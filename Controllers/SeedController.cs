...
{   
    ...
    public class SeedController : ControllerBase
    {
        ...
        public async Task<ActionResult> Import()
        {
            ...
            {
                var row = worksheet.Cells[nRow, 1, nRow, worksheet.Dimension.End
                .Column];
                ...
                {
                    Name = countryName, Iso2 = iso2, Iso3 = iso3
                };
            ...
            var cities = _context.Cities.AsNoTracking()
                                 .ToDictionary(x =>
                                     (x.Name, x.Lat, x.Lon, x.CountryId));
            ...
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                var
                    nameAscii = row[nRow, 2].GetValue<string>();
                var
                    lat = row[nRow, 3].GetValue<decimal>();
                var
                    lon = row[nRow, 4].GetValue<decimal>();
                var
                    countryName = row[nRow, 5].GetValue<string>();
